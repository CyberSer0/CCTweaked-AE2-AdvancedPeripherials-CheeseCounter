Simple lua script that displays a point on a graph on a connected monitor each `sampleInterval` (in seconds) and draws it's change in | bars relative to the last point.
